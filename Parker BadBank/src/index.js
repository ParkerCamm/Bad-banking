...
function Spa() {
  ...
  const [userDB, setUserDB] = React.useState({ users: [{ name: 'Parker', email: 'parker@mit.edu', password: 'secret', balance: 100 }, { name: 'Parker', email: 'parker@mit.com', password: 'secret', balance: 200000 }] });
